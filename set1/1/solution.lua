...
test_a = hex2bytearray("1c0111001f010100061a024b53535009181c")
test_b = hex2bytearray("686974207468652062756c6c277320657965")
test_c = bytearrayxor(test_a, test_b)
print(bytearray2hex(test_c))

print(bytearray2base64(hex2bytearray("aa")))
print(bytearray2base64(hex2bytearray("49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d")))
